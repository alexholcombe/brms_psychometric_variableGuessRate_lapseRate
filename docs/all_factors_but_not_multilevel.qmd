...
trials <- generate_conditions_both_labs(laboratories,numSubjects,trialsPerCondition,
...
checkCombosOccurEqually(trials |> filter(lab=="Holcombe"),
                        c("subj","num_targets","speed"),dropZeros=FALSE) 
checkCombosOccurEqually(trials |> filter(lab=="Holcombe"),
                        c("subj","num_targets","speed","gender","age_group"),dropZeros=FALSE) 
...
So I even number participants separately within age*gender to maintain the age and gender penalties.
