...
TO-DO:
  ...
  - Make it multilevel, with multiple participants
...
library(tidyverse)
library(brms)
library(here) #For finding home directory
...
target_penalty<-0 #0.15 #penalty for additional target
...
if (all(est_no_sigma$outside_CI==0)) {
  ...
  print('Estimates falling outside CI:')
