...
my_priors <- c( logSigma_prior, eta_prior #lapseRate_prior,  #Intercept priors
...
Look at what is happening during the chain, as explained on te [Stan forum](https://discourse.mc-stan.org/t/init-not-using-my-initial-values-and-seems-to-be-defaulting-to-0/39548)
