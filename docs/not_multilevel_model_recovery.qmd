...
eta_differences_prior_distribution<- sprintf("normal(%s, %s)", eta_param1, eta_param2)
logsigma_prior_distribution<- sprintf("uniform(%s, %s)", logsigma_param1, logsigma_param2)

eta_param1younger<- -1.5
eta_param2younger<- 1.5
...
ageGroupyounger_prior<- brms::set_prior(eta_differences_prior_distribution, 
                          coef="ageGroupyounger",
                          nlpar = "eta")

my_priors <- c( lapseRate_prior, eta_prior,
                logSigma_prior, ageGroupyounger_prior)
