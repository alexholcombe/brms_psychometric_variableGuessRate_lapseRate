...
-   `chanceRate + (1-chanceRate-lapse)*(1-plogis((speed-location)/scale). #change to -speed`
...
#| echo: false
set.seed(999)
chanceRate <- .1 #probablity of correct just guessing
...
fakedata<- fakedata %>% mutate(
  probabilityCorrect = chanceRate + (1-chanceRate-lapse)*(1-plogis(speed, location = 0.91, scale =0.2))
)
