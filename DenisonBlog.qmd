...
\*note need to check that the figure actually animates in blog, not just image
...
We the fitted the model was aligned with the simulated data, meaning the model recovery was a success!!
